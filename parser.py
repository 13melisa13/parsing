...
class UiParser(QtWidgets.QMainWindow):
    ...
    def update_uybor_clicked(self):
        ...
        self.progress_bar.setProperty("value", 0)
        create_internal_excel_file("uybor", fill_sheet_uybor, self.progress_bar, main_window=self)
    ...
    def update_olx_clicked(self):
        ...
        create_internal_excel_file("olx", fill_sheet_olx, self.progress_bar, main_window=self)
        self.label_progress_bar.setText("Процесс: Завершено")
        self.progress_bar.setProperty("value", 100)
    ...
    def export_button_clicked(self):
        if len(self.results_uybor) + len(self.results_olx) < 0:
            ...
            return
        self.label_progress_bar.setText("Процесс: Экспорт данных из Olx в excel")
        self.progress_bar.setProperty("value", 0)
        create_filtered_excel_file(fill_filtered_data, "olx", self.results_olx,
                                   progress=self.progress_bar, main_window=self)
        time.sleep(2)
        self.label_progress_bar.setText("Процесс: Экспорт данных из UyBor в excel")
        self.progress_bar.setProperty("value", 0)
        create_filtered_excel_file(fill_filtered_data, "uybor", self.results_uybor,
                                   progress=self.progress_bar, main_window=self
                                   )
        self.label_progress_bar.setText("Процесс: Завершено")
        self.progress_bar.setProperty("value", 100)
